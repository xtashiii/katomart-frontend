...
export const mockCourses: Course[] = [
  ...
  },
  {
    ...
    description:
      'Learn how to create effective business strategies and implementation plans.',
    category: 'business',
  ...
  },
  {
    ...
    description:
      'Start your journey learning Spanish with basic vocabulary and grammar.',
    category: 'language',
    platform: 'Duolingo',
    progress: 45,
    totalLessons: 60,
  ...
  },
  {
    ...
    description:
      'Mathematical foundations for engineering and computer science.',
    category: 'math',
  ...
  },
  {
    ...
    description:
      'Comprehensive study of the causes, events, and consequences of WWII.',
    category: 'history',
  ...
  },
  {
    ...
    description:
      'Deep dive into JavaScript including closures, prototypes, and async programming.',
    category: 'programming',
  ...
  },
  {
    ...
    description:
      'Learn design patterns and best practices for mobile applications.',
    category: 'design',
    platform: 'Udemy',
    progress: 15,
    totalLessons: 35,
  ...
  },
  {
    ...
    description:
      'Master personal and business financial planning and management.',
    category: 'business',
    platform: 'Coursera',
    progress: 70,
    totalLessons: 30,
  ...
  },
  {
    ...
    description:
      'Improve your French speaking skills through guided conversation practice.',
    category: 'language',
    platform: 'Babbel',
    progress: 25,
    totalLessons: 48,
        ...
        lessons: [
          {
            ...
            description:
              "Understanding what React is and why it's useful for building user interfaces.",
            order: 1,
            hasVideo: true,
          ...
          },
          {
            ...
            description:
              'Learning JSX syntax and creating your first React components.',
            order: 2,
            hasVideo: true,
            videoUrl:
