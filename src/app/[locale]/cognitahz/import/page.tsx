...
export default function ImportCoursePage() {
  ...
  const handleTelegramDataChange = (
    field: keyof TelegramImportData,
    value: unknown
  ) => {
    setFormData((prev) => ({
      ...prev,
  ...
  const simulateFolderScan = async () => {
    ...
    handleInputChange(
      'estimatedLessons',
      mockFiles.filter((f) => f.endsWith('.mp4')).length
    );
  };
    ...
    try {
      ...
      switch (activeTab) {
        case 'upload':
          ...
          result = await CoursesAPI.uploadCourseFiles(
            formData,
        ...
        case 'telegram':
          ...
          result = await CoursesAPI.importFromTelegram(
            formData,
        ...
        case 'folder':
          ...
          result = await CoursesAPI.importFromFolder(
            formData,
            formData.folderPath,
            formData.createWeakLink || false
          );
          break;
      ...
      setImportError(
        error instanceof Error ? error.message : tCommon('importFailed')
      );
    } finally {
          ...
          <div className="import-content">
            ...
            <div className="form-section">
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  <label htmlFor="estimatedLessons">
                    {tCommon('estimatedLessons')}
                  </label>
                  <input
                    id="estimatedLessons"
                    type="number"
                  ...
                  <div className="form-group">
                    <label className="checkbox-label">
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange('requiresAuth', e.target.checked)
                        }
                      />
                      <span>{t('url.requiresAuth')}</span>
                    </label>
                    <small className="info-text">
                      {t('url.requiresAuthDesc')}
                    </small>
                  </div>

                  <small className="info-text">
                    {t('url.supportedSources')}
                  </small>
                </div>
              )}
                ...
                <div className="telegram-section">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTelegramDataChange('channelId', e.target.value)
                      }
                      placeholder={t('telegram.channelIdPlaceholder')}
                      className="form-input"
                    />
                    <small className="info-text">
                      {t('telegram.channelIdHelp')}
                    </small>
                  </div>
                    ...
                    <div className="radio-group">
                      <label className="radio-label">
                        <input
                          ...
                          onChange={() =>
                            handleTelegramDataChange('authMethod', 'bot')
                          }
                        />
                      ...
                      <label className="radio-label">
                        <input
                          ...
                          name="authMethod"
                          checked={
                            formData.telegramData?.authMethod === 'telethon'
                          }
                          onChange={() =>
                            handleTelegramDataChange('authMethod', 'telethon')
                          }
                        />
                    ...
                    <div className="radio-group">
                      <label className="radio-label">
                        <input
                          ...
                          name="contentFormat"
                          checked={
                            formData.telegramData?.contentFormat === 'stream'
                          }
                          onChange={() =>
                            handleTelegramDataChange('contentFormat', 'stream')
                          }
                        />
                      ...
                      <label className="radio-label">
                        <input
                          ...
                          name="contentFormat"
                          checked={
                            formData.telegramData?.contentFormat === 'zip'
                          }
                          onChange={() =>
                            handleTelegramDataChange('contentFormat', 'zip')
                          }
                        />
                  ...
                  <div className="form-grid">
                    <div className="form-group">
                      <label htmlFor="startMessage">
                        {t('telegram.startMessage')}
                      </label>
                      <input
                        id="startMessage"
                        type="number"
                        ...
                        onChange={(e) =>
                          handleTelegramDataChange('messageRange', {
                ...
                <div className="folder-section">
                    ...
                    <div className="radio-group">
                      <label className="radio-label">
                        <input
                          ...
                          onChange={() =>
                            handleInputChange('createWeakLink', true)
                          }
                        />
                      ...
                      <label className="radio-label">
                        <input
                          ...
                          checked={!formData.createWeakLink}
                          onChange={() =>
                            handleInputChange('createWeakLink', false)
                          }
                        />
                  ...
                  {folderScanResults.length > 0 && (
                    <div className="scan-results">
                      <h4>
                        {t('folder.filesFound', {
                          count: folderScanResults.length,
                        })}
                      </h4>
                      <ul className="file-list">
                        ...
                        {folderScanResults.length > 10 && (
                          <li>
                            {t('folder.moreFiles', {
                              count: folderScanResults.length - 10,
                            })}
                          </li>
                        )}
                      </ul>
