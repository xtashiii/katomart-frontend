...
import { faCog, faUsers, faWrench, faChartLine } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="documentation-page">
      <div className="documentation-header">
        ...
        <div className="documentation-hero">
          ...
          <h1 className="documentation-title">{tSections('adminPanel.title')}</h1>
          <p className="documentation-subtitle">{tSections('adminPanel.description')}</p>
        </div>
      </div>
      ...
      <div className="documentation-content-body">
        <div className="content-section">
          <div className="sections-grid">
            {adminSections.map((section) => (
              ...
              >
                <div className={`section-icon bg-gradient-to-br ${section.color}`}>
        ...
        <div className="content-section">
          <div className="next-steps-card">
            <h2 className="next-steps-title">Need to access the Admin Panel?</h2>
